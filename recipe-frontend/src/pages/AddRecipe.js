  ...
  const formSubmitHandler = async(e) => {
    ...
    try {
       if (formData.ingredients){
        formData.ingredients = formData.ingredients ? formData.ingredients.split(",") : formData.ingredients
     }
     if (formData.instructions){
      formData.instructions = formData.instructions ? formData.instructions.split(",") : formData.instructions;
   }
